"""Moved — XRS figures now live under ``science/plots/``.
...
keep working. New code should import from:
    ...
    beamtimehero_cli.science.plots.xrs
...
from beamtimehero_cli.science.plots.xrs import (  # noqa: F401
    plot_elastic_fit,
    plot_loss_spectrum,
    plot_background_subtraction,
    plot_overlay,
    plot_xrs_descriptors,
    plot_crystal_sum,
)
