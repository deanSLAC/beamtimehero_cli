"""Matplotlib figures for the EXAFS pipeline (k- and R-space).

Mirrors ``spec_data/xrs_plotting.py`` conventions; ``fig_to_base64`` is
re-exported from ``plotting`` for tools_core. Every R-space axis label says
"phase-uncorrected" — apparent distances sit ~0.3–0.5 Å below bond lengths
and figures must not invite misreading.
"""
...
from .plotting import fig_to_base64  # noqa: F401  (re-exported for tools_core)
